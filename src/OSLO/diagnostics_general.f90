...
module diagnostics_general
  ...
  integer,parameter :: ncPL = 25 !RBS 4-5 -> 6
  integer,dimension(ncPL), parameter :: compsPL = (/5,6,7,8,9,13,14,16,20,35,46,48, 50,52,77, 78, 80, 81, 83, 84, 85,86,113,114,193/) !Add for VOCMIP
