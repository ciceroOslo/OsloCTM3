...
contains
  ...
  subroutine OSLO_CHEM ( &
       ...
       VDEP_OC, &
       LSULPHUR, LNITRATE, LSOA, LHAL, LM7, &
    ...
    use chem_oslo_rates, only: &
         ...
         !// Halogen Reactions, Added Srinath Krishnan May 2024
         !// Chlorine
         r_cl_ch3o2, r_cl_ch3ooh, r_cl_c2h6, r_cl_c2h5o2, r_cl_c2h5oh, & 
         r_cl_ch3cooh, r_cl_c3h8_a, r_cl_c3h8_b, r_cl_ch3coch3, r_cl_isop, &
         r_cl_ch3oh, r_cl_alkan, r_cl_c3h6, r_cl_ch3cl, r_cl_h2o2, &
         r_cl_ho2, r_cl_ho2, r_cl_o3, r_cl_clno3, r_clo_clo_a, &
         r_clo_clo_b, r_clo_clo_c, r_clo_ho2, r_clo_no, r_cloo_cl_a, &
         r_cloo_cl_b, r_clo_ch3o2,  r_oh_ch3cl, r_oh_ch2cl2, r_oh_chcl3, &
         r_oh_cl2, r_oh_cl2o2, r_oh_clno2, r_oh_clno3, r_oh_clo_a, &
         r_oh_clo_b, r_oh_hcl, r_oh_hocl, r_oh_oclo, r_cl_ch4, &
         r_cl_c2h4, r_cl_ch2o, r_cl_pan, r_cl_hno3, &
         !// Bromine
         r_br_o3, r_br_ho2, r_br_ch2o, r_br_c2h6, r_br_c3h8, &
         r_br_ch3cho, r_br_ch3coch3, r_br_c3h6, r_br_alken, r_br_brno3, &
         r_br_no3, r_hbr_oh, r_bro_oh, r_bro_ho2, r_bro_no, r_bro_bro_a, &
         r_bro_bro_b, r_br2_oh, r_chbr3_oh, r_ch2br2_oh, r_ch3br_oh, &
         !// Iodine
         r_i_o3, r_i_ho2, r_i2_oh, r_hi_oh, r_hoi_oh, r_io_ho2, &
         r_io_no, r_ch3i_oh, r_ino_ino, r_ino2_ino2,  r_i2_no3, &
         r_ino3_i, r_oio_oio, r_oio_no, r_io_io_a, r_io_io_b, &
         r_io_oio, r_i2o2_a,  r_i2o2_b, r_i2o4, r_ino2, r_ino3, &
         r_io_clo_a, r_io_clo_b, r_io_clo_c, r_i_bro, r_io_br, &
         r_io_bro_a, r_io_bro_b, r_clo_bro_a, r_clo_bro_b, r_clo_bro_c          
    ...
    real(r8) :: &
         ...
         M_NOX, M_NOZ, &
         !// Halogen Species: Added Srinath Krishnan
         M_Br2, M_Br, M_BrO, M_HOBr, M_HBr, M_BrNO2, & 
         M_BrNO3, M_CH3Br, M_CH2Br2, M_CHBr3, &
         M_I2, M_I, M_IO, M_OIO, M_HOI, M_HI, M_INO, &
         M_INO2, M_INO3, M_CH3I, M_CH2I2, M_I2O2, &
         M_I2O3, M_I2O4, M_Iaer, &
         M_Cl2, M_Cl, M_HCl, M_ClO, M_ClNO2, M_ClNO3, &
         M_ClOO, M_OClO, M_HOCl, M_Cl2O2, M_CH3Cl, &
         M_CH2Cl2, M_CHCl3, M_CH2IBr, M_H2ICl, &
         M_Br, M_Cl, M_BrCl
    ...
    real(r8) :: &
         !// Halogen reaction rates; Added by Srinath Krishnan
         k_cl_ch3o2, k_cl_ch3ooh, k_cl_c2h6, k_cl_c2h5o2, k_cl_c2h5oh, &
         k_cl_ch3cooh, k_cl_c3h8_a, k_cl_c3h8_b, k_cl_ch3coch3, &
         k_cl_isop, k_cl_ch3oh, k_cl_alkan, k_cl_c3h6, k_cl_ch3cl, &
         k_cl_h2o2, k_cl_ho2, k_cl_ho2, k_cl_o3, k_cl_clno3, k_clo_clo_a, &
         k_clo_clo_b, k_clo_clo_c, k_clo_ho2, k_clo_no, k_cloo_cl_a, &
         k_cloo_cl_b, k_clo_ch3o2,  k_oh_ch3cl, k_oh_ch2cl2, k_oh_chcl3, &
         k_oh_cl2, k_oh_cl2o2, k_oh_clno2, k_oh_clno3, k_oh_clo_a, &
         k_oh_clo_b, k_oh_hcl, k_oh_hocl, k_oh_oclo, k_cl_ch4, k_cl_c2h4, &
         k_cl_ch2o, k_cl_pan, k_cl_hno3, &
         k_br_o3, k_br_ho2, k_br_ch2o, k_br_c2h6, k_br_c3h8, k_br_ch3cho, &
         k_br_ch3coch3, k_br_c3h6, k_br_alken, k_br_brno3, k_br_no3, &
         k_hbr_oh, k_bro_oh, k_bro_ho2, k_bro_no, k_bro_bro_a, k_bro_bro_b, &
         k_br2_oh, k_chbr3_oh, k_ch2br2_oh, k_ch3br_oh, &
         k_i_o3, k_i_ho2, k_i2_oh, k_hi_oh, k_hoi_oh, k_io_ho2, k_io_no, &
         k_ch3i_oh, k_ino_ino, k_ino2_ino2,  k_i2_no3, k_ino3_i, k_oio_oio, &
         k_oio_no, k_io_io_a, k_io_io_b, k_io_oio, k_i2o2_a,  &
         k_i2o2_b, k_i2o4, k_ino2, k_ino3, k_io_clo_a, &
         k_io_clo_b, k_io_clo_c, k_i_bro, k_io_br, k_io_bro_a, &
         k_io_bro_b, k_clo_bro_a, k_clo_bro_b, k_clo_bro_c
    ...
    real(r8) :: &
         ...
         !// J-values for halogen reactions
         DBR2, DBRNO2, DBRONO2_A, DBRONO2_B, DBRO, DCH3BR, &
         DCH2BR2, DCHBR3, DHOBR, DBRCL, DCH2IBR, DIBR, DCH2I2, DCH3I, &
         DHOI, DINO3, DI2, DINO2, DINO, DIO, DOIO, DICL, DCH2CL, DCH2CL2, &
         DCH3CL, DCL2O2, DCL2, DCLNO2, DCLONO2_A, DCLONO2_B, DCLOO, DCLO, &
         DHOCL, DOCLO, DI2O2, DI2O3, DI2O4, &
    ...
    do L = 1, LMTROP !// Integrate up to LMTROP
      ...
      !//Halogen Temperature Reactions
      k_cl_ch3o2 = r_cl_ch3o2(JTEMP)  
      k_cl_ch3ooh = r_cl_ch3ooh(JTEMP)  
      k_cl_c2h6 = r_cl_c2h6(JTEMP)  
      k_cl_c2h5o2 = r_cl_c2h5o2(JTEMP)  
      k_cl_c2h5oh = r_cl_c2h5oh(JTEMP) 
      k_cl_ch3cooh = r_cl_ch3cooh(JTEMP) 
      k_cl_c3h8_a = r_cl_c3h8_a(JTEMP) 
      k_cl_c3h8_b = r_cl_c3h8_b(JTEMP) 
      k_cl_ch3coch3 = r_cl_ch3coch3(JTEMP) 
      k_cl_isop = r_cl_isop(JTEMP) 
      k_cl_ch3oh = r_cl_ch3oh(JTEMP) 
      k_cl_alkan = r_cl_alkan(JTEMP) 
      k_cl_c3h6 = r_cl_c3h6(JTEMP) 
      k_cl_ch3cl = r_cl_ch3cl(JTEMP) 
      k_cl_h2o2 = r_cl_h2o2(JTEMP) 
      k_cl_ho2 = r_cl_ho2(JTEMP) 
      k_cl_ho2 = r_cl_ho2(JTEMP) 
      k_cl_o3 = r_cl_o3(JTEMP) 
      k_cl_clno3 = r_cl_clno3(JTEMP) 
      k_clo_clo_a = r_clo_clo_a(JTEMP) 
      k_clo_clo_b = r_clo_clo_b(JTEMP) 
      k_clo_clo_c = r_clo_clo_c(JTEMP) 
      k_clo_ho2 = r_clo_ho2(JTEMP) 
      k_clo_no = r_clo_no(JTEMP) 
      k_cloo_cl_a = r_cloo_cl_a(JTEMP) 
      k_cloo_cl_b = r_cloo_cl_b(JTEMP) 
      k_clo_ch3o2 = r_clo_ch3o2(JTEMP) 
      k_oh_ch3cl = r_oh_ch3cl(JTEMP) 
      k_oh_ch2cl2 = r_oh_ch2cl2(JTEMP) 
      k_oh_chcl3 = r_oh_chcl3(JTEMP) 
      k_oh_cl2 = r_oh_cl2(JTEMP) 
      k_oh_cl2o2 = r_oh_cl2o2(JTEMP) 
      k_oh_clno2 = r_oh_clno2(JTEMP) 
      k_oh_clno3 = r_oh_clno3(JTEMP) 
      k_oh_clo_a = r_oh_clo_a(JTEMP) 
      k_oh_clo_b = r_oh_clo_b(JTEMP) 
      k_oh_hcl = r_oh_hcl(JTEMP) 
      k_oh_hocl = r_oh_hocl(JTEMP) 
      k_oh_oclo = r_oh_oclo(JTEMP) 
      k_cl_ch4 = r_cl_ch4(JTEMP) 
      k_cl_c2h4 = r_cl_c2h4(JTEMP) 
      k_cl_ch2o = r_cl_ch2o(JTEMP) 
      k_cl_pan = r_cl_pan(JTEMP) 
      k_cl_hno3 = r_cl_hno3(JTEMP) 
      k_br_o3 = k_br_o3(JTEMP) 
      k_br_ho2 = r_br_ho2(JTEMP) 
      k_br_ch2o = r_br_ch2o(JTEMP) 
      k_br_c2h6 = r_br_c2h6(JTEMP) 
      k_br_c3h8 = r_br_c3h8(JTEMP) 
      k_br_ch3cho = r_br_ch3cho(JTEMP) 
      k_br_ch3coch3 = r_br_ch3coch3(JTEMP) 
      k_br_c3h6 = r_br_c3h6(JTEMP) 
      k_br_alken = r_br_alken(JTEMP) 
      k_br_brno3 = r_br_brno3(JTEMP) 
      k_br_no3 = r_br_no3(JTEMP) 
      k_hbr_oh = r_hbr_oh(JTEMP) 
      k_bro_oh = r_bro_oh(JTEMP) 
      k_bro_ho2 = r_bro_ho2(JTEMP) 
      k_bro_no = r_bro_no(JTEMP) 
      k_bro_bro_a = r_bro_bro_a(JTEMP) 
      k_bro_bro_b = r_bro_bro_b(JTEMP) 
      k_br2_oh = r_br2_oh(JTEMP) 
      k_chbr3_oh = r_chbr3_oh(JTEMP) 
      k_ch2br2_oh = r_ch2br2_oh(JTEMP) 
      k_ch3br_oh = r_ch3br_oh(JTEMP) 
      k_i_o3 = r_i_o3(JTEMP) 
      k_i_ho2 = r_i_ho2(JTEMP) 
      k_i2_oh = r_i2_oh(JTEMP) 
      k_hi_oh = r_hi_oh(JTEMP) 
      k_hoi_oh = r_hoi_oh(JTEMP) 
      k_io_ho2 = r_io_ho2(JTEMP) 
      k_io_no = r_io_no(JTEMP) 
      k_ch3i_oh = r_ch3i_oh(JTEMP) 
      k_ino_ino = r_ino_ino(JTEMP) 
      k_ino2_ino2 = r_ino2_ino2(JTEMP) 
      k_i2_no3 = r_i2_no3(JTEMP) 
      k_ino3_i = r_ino3_i(JTEMP) 
      k_oio_oio = r_oio_oio(JTEMP) 
      k_oio_no = r_oio_no(JTEMP) 
      k_io_io_a = r_io_io_a(JTEMP) 
      k_io_io_b = r_io_io_b(JTEMP) 
      k_io_oio = r_io_oio(JTEMP) 
      k_i2o2_a = r_i2o2_a(JTEMP) 
      k_i2o2_b = r_i2o2_b(JTEMP) 
      k_i2o4 = r_i2o4(JTEMP) 
      k_ino2 = r_ino2(JTEMP) 
      k_ino3 = r_ino3(JTEMP) 
      k_io_clo_a = r_io_clo_a(JTEMP) 
      k_io_clo_b = r_io_clo_b(JTEMP) 
      k_io_clo_c = r_io_clo_c(JTEMP) 
      k_i_bro = r_i_bro(JTEMP) 
      k_io_br = r_io_br(JTEMP) 
      k_io_bro_a = r_io_bro_a(JTEMP) 
      k_io_bro_b = r_io_bro_b(JTEMP) 
      k_clo_bro_a = r_clo_bro_a(JTEMP) 
      k_clo_bro_b = r_clo_bro_b(JTEMP) 
      k_clo_bro_c = r_clo_bro_c(JTEMP) 
      ...
      do NST = 1, NCHEM_ITER
        ...
        !//.. Halogen Reactions Added by Srinath Krishnan 
        if (LHAL) &
               PROD = PROD &
               + k_br_brno3 * M_BR * M_BRNO3 &!Br +	BrNO3 → Br2	+ NO3
               + k_cl_clno3 * M_CL * M_CLNO3 &!Cl + ClNO3 →	Cl2	+ NO3
               + k_oh_clno3 * M_OH * M_CLNO3 &!OH	+ ClNO3 →	HOCl	+ NO3
               + k_ino3_i * M_INO3 * M_I &!INO3 +	I →	I2 +	NO3
               + k_cl_pan * M_CL * M_PAN &!Cl	+ PAN → HCl + CH2O + NO3
               + DINO3 * M_INO3 !INO3 + hv → I + NO3 
        ...
        if (M_O3NO .gt. 0._r8) then
           ...
           !//..Halogen Loss NO is this the right place????
           if (LHAL) &
                   LOSS_NO = LOSS_NO &
                    + k_bro_no * M_BRO &!BrO + NO	→ Br	+ NO2
                    + k_clo_no * M_CLO &!ClO + NO	→ Cl	+ NO2
                    + k_io_no * M_IO &!IO + NO → I + NO2
                    + k_oio_no * M_OIO !OIO + NO → NO2	+ IO          

           if (LHAL) &
                    PROD_NO = PROD_NO &
                     + 2_r8 * k_ino_ino * M_INO &!INO + INO → I2 + 2NO
        ...
        do IIJ = 1, OH_HO2_ITER
          ...
          if (LHAL) &
                    LOSS_OH = LOSS_OH &
                    + k_oh_ch3cl * M_CH3CL &!OH + CH3Cl → Cl + HO2 + H2O
                    + k_oh_ch2cl2 * M_CH2CL2 &!OH + CH2Cl2 → 2Cl + HO2 + H2O
                    + k_oh_chcl3 * M_CHCL3 &!OH +	CHCl3 → 3Cl + HO2 + H2O
                    + k_oh_cl2 * M_CL2 &!OH + Cl2	→ HOCl	+ Cl		
                    + k_oh_cl2o2 * M_CLNO2 &!OH +	Cl2O2 → HOCl + ClOO
                    + k_oh_clno2 * M_CLNO2 &!OH +	ClNO2 → HOCl + NO2		
                    + k_oh_clno3 * M_CLNO3 &!OH +	ClNO3 → HOCl + NO3		
                    + k_oh_clo_a * M_CLO &!OH + ClO → HCl + O2		
                    + k_oh_clo_b * M_CLO &!OH + ClO → HO2 + Cl		
                    + k_oh_hcl * M_HCL &!OH	+ HCl → H2O + Cl		
                    + k_oh_hocl * M_HOCL &!OH + HOCl →	H2O + ClO		
                    + k_oh_oclo * M_OCLO &!OH + OClO →	HOCl	+ O2		
                    + k_oh_br2 * M_BR2 &!Br2 + OH	→ HOBr + Br		
                    + k_oh_bro * M_BRO &!BrO + OH → Br + HO2		
                    + k_oh_ch2br2 * M_CH2BR2 &!CH2Br2 + OH → 2Br + CO		
                    + k_oh_ch3br * M_CH3BR &!CH3Br + OH → Br + CO		
                    + k_oh_ch3i * M_CH3I &!CH3I + OH → H2O + I		
                    + k_oh_chbr3 * M_CHBR3 &!CHBr3 + OH → 3Br + CO		
                    + k_oh_hbr * M_HBR &!HBr	+ OH	→ Br + H2O		
                    + k_oh_hi * M_HI &!HI + OH → I + H2O		
                    + k_oh_hoi * M_HOI &!HOI + OH	→ IO	+ H2O		
                    + k_oh_i2 * M_I2 !I2 + OH → HOI + I		
          ...
          if (LHAL) &
                     LOSS_HO2 = &
                     k_ho2_br * M_BR &!Br + HO2 → HBr + O2
                     + k_ho2_bro * M_BRO &!BrO + HO2 →	HOBr	+ O2		
                     + k_ho2_cl_a * M_CL &!Cl + HO2 → HCl + O2		
                     + k_ho2_cl_b * M_CL &!Cl + HO2 → ClO + OH
                     + k_ho2_clo * M_CLO &!ClO + HO2 → O2 + HOCl		
                     + k_ho2_i * M_I &!I + HO2 → HI + O2
                     + k_ho2_io * M_IO !IO + HO2 → HOI + O2
          ...
          if (LHAL) &
               LOSS = LOSS &
                 + k_cl_pan * M_CL !Cl + PAN	→ HCl + CH2O + NO3          
          ...
          PROD = &
               ...
               + DCH3CL * M_CH3CL !CH3Cl + PHOTON	→ Cl + CH3O2
          ...
          if (LHAL) LOSS = LOSS &
                    ...
                    + k_clo_ch3o2 * M_CLO !ClO + CH3O2 → ClOO + CH2O + HO2
        ...
        if (LHAL) PROD = PROD &
               + k_cl_ch3cl * M_CL * M_CH3CL &!Cl + CH3Cl -> CO + 2HCl + HO2
               + k_ch2br2_oh * M_CH2BR2 * M_OH &!OH + CH2Br2 -> CO + 2Br
               + k_chbr3_oh * M_CHBR3 * M_OH &!OH + CHBr3 -> CO + 3Br
               + k_ch3br_oh * M_CH3BR * M_OH &!OH + CH3Br -> CO + Br
               + k_br_ch2o * M_BR * M_CH2O &!Br + CH2O -> HO2 + CO + HBr
               + k_cl_ch2o * M_CL * M_CH2O !Cl + CH2O -> HO2 + CO + HCl
        ...
        if (LHAL) LOSS = LOSS + k_cl_ch4 * M_CL !Cl + CH4 -> HCl + CH3O2
        ...
        if (LHAL) LOSS = LOSS &
                         + k_br_ch2o * M_Br &!Br + CH2O -> HO2 + CO + HBr
                         + k_cl_ch2o * M_Cl !Cl + CH2O -> HO2 + CO + HCl
        ...
        !SRINATH AND ZOSIA ADDING HALOGEN REACTIONS. PLACE TO BE DETERMINED
        if (LHAL) then
          !//..Chlorine Reactions --------------------------------  
          !//..CH3Cl ---------------------------------------------
          !PROD = ??
          LOSS = &
                 k_cl_ch3cl * M_Cl & !Cl + CH3Cl → CO + 2HCl + HO2
                 + k_oh_ch3cl * M_OH   !OH + CH3Cl → Cl + HO2 + H2O 
  
          !ONLY FOR SHORT LIVED SPECIES - M_CH3CL = PROD / LOSS
          call QSSA(106,'CH3CL',DTCH,QLIN,ST,PROD,LOSS,ZC(106,L))     

          !//..HCl ---------------------------------------------
          PROD = &
                 k_cl_ch3cooh_a * M_CL * M_CH3COOH &!Cl + CH3OOH → HCl + CH3O2
                 + k_cl_c2h6 * M_CL * M_C2H6 &!Cl + C2H6 → HCl + C2H5O2
                 + k_cl_c2h5oh * M_CL * M_C2H5OH &!Cl + C2H5OH → HCl + CH3CHO
                 + k_cl_ch3cooh_b * M_CL * M_CH3COOH &!Cl + CH3COOH → HCl + CH3O2 + CO2
                 + k_cl_c3h8_a * M_CL * M_C3H8 &!Cl + C3H8 → HCl + C3H7O2
                 + k_cl_c3h8_b * M_CL * M_C3H8 &!Cl + C3H8 → HCl + PROPAO2
                 + k_cl_ch3coch3 * M_CL * M_CH3COCH3 &!Cl + CH3COCH3 → HCl + PROPAO2
                 + k_cl_isop * M_CL * M_ISOP &!Cl + ISOP → HCl + ISOPO2
                 + k_cl_ch3oh * M_CL * M_CH3OH &!Cl + CH3OH → HCl + CH2O + HO2
                 + k_cl_alkan * M_CL * M_ALKAN &!Cl + ALKAN → HCl + ALKANO2
                 + k_cl_c3h6 * M_CL * M_C3H6 &!Cl + C3H6 → HCl + PROPEO2
                 + k_cl_ch3cl * M_CL * M_CH3CL &!Cl + CH3Cl → CO + 2HCl + HO2
                 + k_cl_h2o2 * M_CL * M_H2O2 &!Cl + H2O2 → HCl + HO2
                 + k_cl_ho2 * M_CL * M_HO2 &!Cl + HO2 → HCl + O2
                 + k_oh_clo * M_OH * M_CLO &!OH + ClO → HCl + O2
                 + k_cl_ch4 * M_CL * M_CH4 &!Cl + CH4 → HCl + CH3O2
                 + k_cl_c2h4 * M_CL * M_C2H4 &!Cl + C2H4 → HCl + C2H5O2
                 + k_cl_ch2o * M_CL * M_CH2O &!Cl + CH2O → HCl + HO2 + CO
                 + k_cl_pan * M_CL * M_PAN &!Cl + PAN → HCl + CH2O + NO3
                 + k_cl_hno3 * M_CL * M_HNO3 !Cl + HNO3 → HCl + NO2
          ...
          call QSSA(111,'HCL',DTCH,QLIN,ST,PROD,LOSS,ZC(111,L))
          ...
          PROD = &
                 ...
                 + k_cl_c2h5o2 * M_CL * M_C2H5O2 &!Cl + C2H5O2 → ClO + HO2 + CH3CHO
                 + k_cl_ho2 * M_CL * M_HO2 &!Cl + HO2 → ClO + OH
                 + k_cl_o3 * M_CL * M_O3 &!Cl + O3 → ClO + O2
                 + k_cloo_cl * M_CLOO * M_CL &!ClOO + Cl → 2ClO
                 + k_oh_hocl * M_OH * M_HOCL &!OH + HOCl → H2O + ClO
                 + DCLONO2_B * M_CLONO2 &!CLONO2 + hv → ClO + NO2
                 + DCLOO * M_CLOO &!CLOO + hv → ClO + O2
                 + DOCLO * M_OCLO !OClO + hv → ClO + O
          LOSS = &
                 k_clo_clo_a * M_CLO &!ClO + ClO → Cl2 + O2
                 + k_clo_clo_b * M_CLO &!ClO + ClO → OClO + Cl
                 + k_clo_clo_c * M_CLO &!ClO + ClO → Cl + ClOO
                 + k_clo_ho2 * M_HO2 &!ClO + HO2 → O2 + HOCl
                 + k_clo_no * M_NO &!ClO + NO → Cl + NO2
                 + k_clo_ch3o2 * M_CH3O2 &!ClO + CH3O2 → ClOO + HO2 + CH2O
                 + k_oh_clo_a * M_OH &!OH + ClO → HCl + O2
                 + k_oh_clo_b * M_OH &!OH + ClO → HO2 + Cl
                 + k_io_clo_a * M_IO &!IO + ClO → I + OClO
                 + k_io_clo_b * M_IO &!IO + ClO → I + Cl + O2
                 + k_io_clo_c * M_IO &!IO + ClO → ICl + O2
                 + k_clo_bro_a * M_BRO &!ClO + BrO → OClO + Br
                 + k_clo_bro_b * M_BRO &!ClO + BrO → Br + Cl + O2
                 + k_clo_bro_c * M_BRO &!ClO + BrO → BrCl + O2
                 + DCLO !ClO + hv → Cl
  
          call QSSA(133,'CLO',DTCH,QLIN,ST,PROD,LOSS,ZC(133,L))
          !//..IS THIS HOCl same as OHCl ----- 
          !//..HOCl ---------------------------------------------
          PROD = &
                 k_clo_ho2 * M_CLO * M_HO2 &!ClO + HO2 → O2 + HOCl
                 + k_oh_cl2 * M_OH * M_CL2 &!OH + Cl2 → HOCl + Cl
                 + k_oh_cl2o2 * M_OH * M_CL2O2 &!OH + Cl2O2 → HOCl + ClOO
                 + k_oh_clno2 * M_OH * M_CLNO2 &!OH + ClNO2 → HOCl + NO2
                 + k_oh_clno3 * M_OH * M_CLNO3 &!OH + ClNO3 → HOCl + NO3
                 + k_oh_oclo * M_OH * M_OCLO !OH + OClO → HOCl + O2
          ...
          PROD = &
                 k_cl_clno3 * M_CL * M_CLNO3 &!Cl + ClNO3 → Cl2 + NO3
                 + k_clo_clo * M_CLO * M_CLO &!ClO + ClO → Cl2 + O2
                 + k_cloo_cl * M_CLOO * M_CL !ClOO + Cl → Cl2 + O2
  
          LOSS = &
                 k_oh_cl2 * M_OH &!OH + Cl2 → HOCl + Cl
                 2_r8 * DCL2 !Cl2 + hv → 2Cl

          call QSSA(136,'CL2',DTCH,QLIN,ST,PROD,LOSS,ZC(136,L))

          !//..OClO ---------------------------------------------
          PROD = &
                 k_io_clo * M_IO * M_CLO &!IO + ClO → I + OClO
                 + k_clo_bro * M_CLO * M_BRO !ClO + BrO → OClO + Br
          
          LOSS = &
                 k_clo_clo_b * M_CLO &!ClO + ClO → OClO + Cl
                 + k_oh_oclo * M_HOCL &!OH + OClO → HOCl + O2
                 + DOCLO !OClO + hv	→ ClO + O

          call QSSA(137,'OCLO',DTCH,QLIN,ST,PROD,LOSS,ZC(137,L))       
          !//..ClOO ---------------------------------------------
          PROD = &
                 k_clo_clo_c * M_CLO &!ClO + ClO → Cl + ClOO
                 + k_clo_ch3o2 * M_CLO * M_CH3O2 &!ClO + CH3O2 → ClOO + HO2 + CH2O
                 + k_oh_c12o2 * M_OH * M_Cl2O2 &!OH + Cl2O2 → HOCl + ClOO
                 + DCL2O2 * M_CL2O2 !Cl2O2 + hv → Cl + ClOO
          
          LOSS = &
                 k_cloo_cl_a * M_CL &!ClOO + Cl → 2ClO
                 + k_cloo_cl_b * M_CL &!ClOO + Cl → Cl2 + O2
                 + DCLOO !ClOO + hv → ClO + O2
          
          call QSSA(144,'CLOO',DTCH,QLIN,ST,PROD,LOSS,ZC(144,L))

          !//..Cl2O2 ---------------------------------------------
          !PROD = ??
  
          LOSS = &
                 k_oh_cl2o2 * M_OH &!OH + Cl2O2 → HOCl + ClOO
                 + DCL2O2 !Cl2O2 + hv → Cl + ClOO
          
          call QSSA(145,'CL2O2',DTCH,QLIN,ST,PROD,LOSS,ZC(145,L))

          !//..ClNO2 ---------------------------------------------
          !PROD = ??
  
          LOSS = &
                 k_oh_clno2 * M_OH &!OH + ClNO2 → HOCl + NO2
                 + DCLNO2 !ClNO2 + hv → Cl + NO2
          
          call QSSA(153,'CLNO2',DTCH,QLIN,ST,PROD,LOSS,ZC(153,L)) 

          !//..ClNO3 ---------------------------------------------
          !PROD = ??
          
          LOSS = &
                 k_oh_clno3 * M_OH !OH + ClNO3 → HOCl + NO3
  
          call QSSA(172,'CLNO3',DTCH,QLIN,ST,PROD,LOSS,ZC(172,L))

          !//..CH2Cl2 ---------------------------------------------
          !PROD = ??
  
          LOSS = &
                 k_oh_ch2cl2 * M_OH &!OH + CH2Cl2 → 2Cl + HO2 + H2O
                 + 2_r8 * DCH2CL2 !CH2Cl2 + hv → 2Cl
          call QSSA(154,'CH2CL2',DTCH,QLIN,ST,PROD,LOSS,ZC(154,L))     
                 
          !//..CHCl3 ---------------------------------------------
          !PROD = ??
          
          LOSS = &
                 k_oh_chcl3 * M_OH !OH + CHCl3 → 3Cl + HO2 + H2O
          call QSSA(155,'CHCL3',DTCH,QLIN,ST,PROD,LOSS,ZC(155,L))
                 
          !//..ICl ---------------------------------------------
          PROD = &
                 k_io_clo * M_IO * M_CLO !IO + ClO → ICl + O2
  
          LOSS = &
                 + DICL !ICl + hv → I + Cl

          call QSSA(171,'ICL',DTCH,QLIN,ST,PROD,LOSS,ZC(171,L))

          !//..BrCl ---------------------------------------------
          PROD = &
                 k_clo_bro * M_CLO * M_BRO !ClO + BrO → BrCl + O2
  
          LOSS = &
                 + DBRCL !BrCl + hv → Br + Cl
          call QSSA(146,'BRCL',DTCH,QLIN,ST,PROD,LOSS,ZC(146,L))


          !//..Cl ---------------------------------------------
          PROD = &
                 k_clo_clo_b * M_CLO * M_CLO  &!ClO + ClO → OClO + Cl
                 + k_clo_clo_c * M_CLO * M_CLO &!ClO + ClO → Cl + ClOO
                 + k_oh_cl2 * M_OH * M_CL2 &!OH + Cl2 → HOCl + Cl
                 + k_oh_clo * M_OH * M_CLO &!OH + ClO → HO2 + Cl
                 + k_oh_hcl * M_OH * M_HCL &!OH + HCl → H2O + Cl
                 + k_oh_ch3cl * M_OH * M_CH3CL &!OH + CH3Cl → Cl + HO2 + H2O
                 + 2_r8 * k_oh_ch2cl2 * M_OH * M_CH2CL2 &!OH + CH2Cl2 → 2Cl + HO2 + H2O
                 + 3_r8 *  k_oh_chcl3 * M_OH * M_CHCL3 &!OH + CHCl3 → 3Cl + HO2 + H2O
                 + k_io_clo * M_IO * M_CLO &!IO + ClO → I + Cl + O2
                 + k_clo_bro * M_CLO * M_BRO !ClO + BrO → Br + Cl + O2
  
          LOSS = &
                 k_cl_ch3o2 * M_CH3O2 &!Cl + CH3O2 → ClO + CH2O + HO2
                 + k_cl_ch3ooh * M_CH3OOH &!Cl + CH3OOH → HCl + CH3O2
                 + k_cl_c2h6 * M_C2H6 &!Cl + C2H6 → HCl + C2H5O2
                 + k_cl_c2h5o2 * M_C2H5O2 &!Cl + C2H5O2 → ClO + HO2 + CH3CHO
                 + k_cl_c2h5oh * M_C2H5OH &!Cl + C2H5OH → HCl + CH3CHO
                 + k_cl_ch3cooh * M_CH3COOH &!Cl + CH3COOH → HCl + CH3O2 + CO2
                 + k_cl_c3h8_a * M_C3H8 &!Cl + C3H8 → HCl + C3H7O2
                 + k_cl_c3h8_b * M_C3H8 &!Cl + C3H8 → HCl + PROPAO2
                 + k_cl_ch3coch3 * M_CH3COCH3 &!Cl + CH3COCH3 → HCl + PROPAO2
                 + k_cl_isop * M_ISOP &!Cl + ISOP → HCl + ISOPO2
                 + k_cl_ch3oh * M_CH3OH &!Cl + CH3OH → HCl + CH2O + HO2
                 + k_cl_alkan * M_ALKAN &!Cl + ALKAN → HCl + ALKANO2
                 + k_cl_c3h6 * M_C3H6 &!Cl + C3H6 → HCl + PROPEO2
                 + k_cl_ch3cl * M_CH3CL &!Cl + CH3Cl → CO + 2HCl + HO2
                 + k_cl_h2o2 * M_H2O2 &!Cl + H2O2 → HCl + HO2
                 + k_cl_ho2_a * M_HO2 &!Cl + HO2 → HCl + O2
                 + k_cl_ho2_b * M_HO2 &!Cl + HO2 → ClO + OH
                 + k_cl_o3 * M_O3 &!Cl + O3 → ClO + O2
                 + k_cl_clno3 * M_CLNO3 &!Cl + ClNO3 → Cl2 + NO3
                 + k_cloo_cl_a * M_CLOO &!ClOO + Cl → 2ClO
                 + k_cloo_cl_b * M_CLOO &!ClOO + Cl → Cl2 + O2
                 + k_cl_ch4 * M_CH4 &!Cl + CH4 → HCl + CH3O2
                 + k_cl_c2h4 * M_C2H4 &!Cl + C2H4 → HCl + C2H5O2
                 + k_cl_ch2o * M_CH2O &!Cl + CH2O → HCl + HO2 + CO
                 + k_cl_pan * M_PAN &!Cl + PAN → HCl + CH2O + NO3
                 + k_cl_hno3 * M_HNO3 &!Cl + HNO3 → HCl + NO2
                 + DICL * M_ICL &!ICl + PHOTON	→ I + Cl
                 + DCH2ICL * M_CH2ICL &!CH2ICl + PHOTON	→ I + Cl
                 + 2._r8 * DCH2CL2 * M_CH2CL2 &!CH2Cl2 + PHOTON → 2Cl
                 + DCH3CL * M_CH3CL &!CH3Cl + PHOTON → Cl + CH3O2
                 + DCL2O2 * M_CL2O2 &!Cl2O2 + PHOTON → Cl + ClOO
                 + 2._r8 * DCL2 * M_CL2 &!Cl2 + PHOTON → 2Cl
                 + DCLNO2 * M_CLNO2 &!ClNO2 + PHOTON → Cl + NO2
                 + DCLONO2 * M_CLONO2 &!ClONO2 + PHOTON → Cl + NO2
                 + DCLO * M_CLO &!ClO + PHOTON → Cl
                 + DHOCL * M_HOCL !HOCl + PHOTON → Cl + OH
          
          !THERE IS A CLx and a CLy. WHICH ONE IS CORRECT?
          !call QSSA(112,'CL',DTCH,QLIN,ST,PROD,LOSS,ZC(112,L))
          ...
          !PROD = ??
          LOSS = &
                 DCLONO2_A &!ClONO2 + PHOTON → Cl + NO2
                 + DCLONO2_B !ClONO2 + PHOTON → ClO + NO2
          
          call QSSA(135,'CLONO2',DTCH,QLIN,ST,PROD,LOSS,ZC(135,L))
          ...
          LOSS = &
                 k_ch3br_oh * M_OH &!CH3Br + OH → Br + CO
                 + DCH3BR
          call QSSA(116,'CH3BR',DTCH,QLIN,ST,PROD,LOSS,ZC(116,L))

          !//..HBr ---------------------------------------------
          PROD = &
                 k_br_ho2 * M_BR * M_HO2 &!Br + HO2 → HBr + O2
                 + k_br_ch2o * M_BR * M_CH2O &!Br + CH2O → HO2 + CO + HBr
                 + k_br_c2h6 * M_BR * M_C2H6 &!Br + C2H6 → C2H5O2 + HBr
                 + k_br_c3h8 * M_BR * M_C3H8 &!Br + C3H8 → C3H7O2 + HBr
                 + k_br_ch3cho * M_BR * M_CH3CHO &!Br + CH3CHO → CH3CO3 + HBr
                 + k_br_ch3coch3 * M_BR * M_CH3COCH3 &!Br + CH3COCH3 → PROPAO2 + HBr
                 + k_br_c3h6 * M_BR * M_C3H6 &!Br + C3H6 → PROPEO2 + HBr
                 + k_br_alken * M_BR * M_ALKEN !Br + ALKEN → ALKENO2 + HBr
          LOSS = &
                 k_hbr_oh * M_OH !HBr + OH → Br + H2O
          
          call QSSA(140,'HBR',DTCH,QLIN,ST,PROD,LOSS,ZC(140,L))

          !//..BrONO2 ------CHECK---------------------------------------
          !PROD = &
  
          LOSS = &      
                 DBRONO2_A &!BrONO2 + PHOTON →	BrO + NO2	(0.15)
                 + DBRONO2_B !BrONO2 + PHOTON → Br + NO2	(0.85)
          call QSSA(141,'BRONO2',DTCH,QLIN,ST,PROD,LOSS,ZC(141,L))

          !//..HOBr ---CHECK WITH OHBR-------
          PROD = &
                 k_bro_ho2 * M_BRO * M_HO2 &!BrO + HO2 → HOBr + O2
                 + k_br2_oh * M_BR2 * M_OH !Br2 + OH → HOBr + Br
          LOSS = &
                 DHOBR !HOBr + PHOTON → Br + OH
          
          !//..Br2 ---------------------------------------------
          PROD = &
                 k_br_brno3 * M_BR * M_BRNO3 &!Br + BrNO3 → Br2 + NO3
                 + k_bro_bro * M_BRO * M_BRO !BrO + BrO → Br2 + O2
          LOSS = &               
                 DBR2 ! Br2 + PHOTON → 2Br
          
          call QSSA(143,'BR2',DTCH,QLIN,ST,PROD,LOSS,ZC(143,L))
          ...
          LOSS = &      
                 DBRNO2 !BrNO2 + PHOTON → Br + NO2

          call QSSA(149,'BRNO2',DTCH,QLIN,ST,PROD,LOSS,ZC(149,L))

          !//..BrNO3 ---------------------------------------------
          PROD = &
  
          LOSS = &               
                 k_br_brno3 * M_BR !Br + BrNO3 → Br2 + NO3

          call QSSA(150,'BRNO3',DTCH,QLIN,ST,PROD,LOSS,ZC(150,L))

          !//..CH2Br2 ---------------------------------------------
          !PROD = &
  
          LOSS = &               
                 k_ch2br2_oh * M_OH &!CH2Br2 + OH → 2Br + CO
                 + DCH2BR2 !CH2Br2 + PHOTON →	2Br
          
          call QSSA(151,'CH2BR2',DTCH,QLIN,ST,PROD,LOSS,ZC(151,L))

          !//..CHBr3 ---------------------------------------------
          PROD = &
  
          LOSS = &               
                 k_chbr3_oh * M_OH &!CHBr3 + OH → 3Br + CO
                 + DCHBR3 !CHBr3 + PHOTON → 3Br
          call QSSA(152,'CHBR3',DTCH,QLIN,ST,PROD,LOSS,ZC(152,L))

          !//..CH2IBr ---------------------------------------------
          PROD = &
  
          LOSS = &               
                 DCH2IBR !CH2IBr + PHOTON → I + Br
          
          call QSSA(168,'CH2IBR',DTCH,QLIN,ST,PROD,LOSS,ZC(168,L))

          !//..IBr ---------------------------------------------
          !PROD = &
  
          LOSS = &               
                 DIBR !IBr + PHOTON → I + Br
          call QSSA(170,'IBR',DTCH,QLIN,ST,PROD,LOSS,ZC(170,L))

          !//..Br ---------------------------------------------
          PROD = &
                 k_hbr_oh * M_HBR * M_OH &!HBr + OH → Br + H2O
                 + k_bro_oh * M_BRO * M_OH &!BrO + OH → Br + HO2
                 + k_bro_no * M_BRO * M_NO &!BrO + NO → Br + NO2
                 + k_bro_bro * M_BRO * M_BRO &!BrO + BrO → 2Br + O2
                 + k_chbr3_oh * M_CHBr3 * M_OH &!CHBr3 + OH → 3Br + CO
                 + k_ch2br2 * M_CH2BR2 * M_OH &!CH2Br2 + OH → 2Br + CO
                 + k_ch3br * M_CH3BR * M_OH &!CH3Br + OH → Br + CO
                 + k_i_bro * M_I * M_BRO &!I + BrO → IO + Br
                 + k_io_bro_a * M_IO * M_BRO &!IO + BrO → Br + I + O2
                 + k_io_bro_b * M_IO * M_BRO &!IO + BrO → Br + OIO
                 + k_clo_bro_a * M_CLO * M_BRO &!ClO + BrO → OClO + Br
                 + k_clo_bro_b * M_CLO * M_BRO &!ClO + BrO → Br + Cl + O2
                 + 2._r8 * DBR2 * M_BR2 &!Br2 + PHOTON → 2Br
                 + DBRNO2 * M_BRNO2 &!BrNO2 + PHOTON → Br +	NO2
                 + DBRONO2 * M_BRONO2 &!BrONO2 + PHOTON	→ Br	+ NO2 (0.85)
                 + DBRO * M_BRO &!BrO + PHOTON	→ Br
                 + DCH3BR * M_CH3BR &! CH3Br + PHOTON → Br
                 + 2._r8 * DCH2BR2 * M_CH2BR2 &!CH2Br2 + PHOTON → 2Br
                 + 3._r8 * DCHBR3 * M_CHBR3 &!CHBr3 + PHOTON	→ 3Br
                 + DHOBR * MHOBR &!HOBr + PHOTON → Br + OH
                 + DBRCL * M_BRCL &!BrCl + PHOTON → Br + Cl
                 + DCH2IBR * M_CH2IBR &! CH2IBr + PHOTON	→ I + Br
                 + DIBR * M_IBR !IBr + PHOTON	→ I + Br
  
          LOSS = &               
                 k_br_o3 * M_O3 &!Br + O3 → BrO + O2
                 + k_br_ho2 * M_HO2 &!Br + HO2 → HBr + O2
                 + k_br_ch2o * M_CH2O &!Br + CH2O → HO2 + CO + HBr
                 + k_br_c2h6 * M_C2H6 &!Br + C2H6 → C2H5O2 + HBr
                 + k_br_c3h8 * M_C3H8 &!Br + C3H8 → C3H7O2 + HBr
                 + k_br_ch3cho * M_CH3CHO &!Br + CH3CHO → CH3CO3 + HBr
                 + k_br_ch3coch3 * M_CH3COCH3 &!Br + CH3COCH3 → PROPAO2 + HBr
                 + k_br_c3h6 * M_C3H6 &!Br + C3H6 → PROPEO2 + HBr
                 + k_br_alken * M_ALKEN &!Br + ALKEN → ALKENO2 + HBr
                 + k_br_brno3 * M_BRNO3 &!Br + BrNO3 → Br2 + NO3
                 +  k_br_no3 * M_NO3 &!Br + NO3 → BrO + NO2
                 + k_io_br * M_IO !IO + Br → I + BrO
            
          call QSSA(138,'BR',DTCH,QLIN,ST,PROD,LOSS,ZC(138,L))

          !//..BrO ---------------------------------------------
          PROD = &
                 k_br_o3 * M_BR * M_O3 &!Br + O3 → BrO + O2
                 + k_br_no3 * M_BR * M_NO3 &!Br + NO3 → BrO + NO2
                 + k_io_br * M_IO * M_Br &!IO + Br → I + BrO
                 + DBRONO2 * M_BRONO2 !BrONO2 + PHOTON → BrO + NO2 (0.15)
  
          LOSS = &               
                 k_bro_oh * M_OH &!BrO + OH → Br + HO2
                 + k_bro_ho2 * M_HO2 &!BrO + HO2 → HOBr + O2
                 + k_bro_no * M_NO &!BrO + NO → Br + NO2
                 + k_bro_bro_a * M_BRO &!BrO + BrO → 2Br + O2
                 + k_bro_bro_b * M_BRO &!BrO + BrO → Br2 + O2
                 + k_i_bro * M_I &!I + BrO → IO + Br
                 + k_io_bro_a * M_IO &!IO + BrO → Br + I + O2
                 + k_io_bro_b * M_IO &!IO + BrO → Br + OIO
                 + k_clo_bro_a * M_CLO &!ClO + BrO → OClO + Br
                 + k_clo_bro_b * M_CLO &!ClO + BrO → Br + Cl + O2
                 + k_clo_bro_c * M_CLO &!ClO + BrO → BrCl + O2
                 + DBRO !BrO + PHOTON → Br
  
          call QSSA(139,'BRO',DTCH,QLIN,ST,PROD,LOSS,ZC(139,L))
  
          !//..Iodine Reactions --------------------------------  
          !//..I2 ---------------------------------------------
          PROD = &
                 2 * k_ino_ino * M_INO &!INO + INO → I2 + 2NO
                 + k_ino3_I * M_ino3 * M_I &!INO3 + I → I2 + NO3
                 + 2 * k_ino2_ino2 * M_INO2 !INO2 + INO2 → I2 + 2NO2
  
          LOSS = &               
                 k_i2_oh * M_OH &!I2 + OH → HOI + I
                 + k_i2_no3 * M_NO3 &!I2 + NO3 → I + INO3 
                 + 2._r8 * DI2 !I2 + PHOTON → 2I        

          call QSSA(156,'I2',DTCH,QLIN,ST,PROD,LOSS,ZC(156,L))

          !//..HOI ---------------------------------------------
          PROD = &
                 k_io_ho2 * M_IO * M_HO2 &!IO + HO2 → HOI + O2
                 + k_i2_oh * M_I2 * M_OH !I2 + OH → HOI + I
          LOSS = &               
                 k_hoi_oh * M_OH &!HOI + OH → IO + H2O
                 + DHOI !HOI + PHOTON → I + OH
          call QSSA(157,'HOI',DTCH,QLIN,ST,PROD,LOSS,ZC(157,L))

          !//..HI ---------------------------------------------
          PROD = &
                 k_i_ho2 * M_I * M_HO2 !I + HO2 → HI + O2    
          LOSS = &               
                 k_hi_oh * M_OH !HI + OH → I + H2O
  
          call QSSA(158,'HI',DTCH,QLIN,ST,PROD,LOSS,ZC(158,L))
          ...
          LOSS = &               
                 2 * k_ino_ino * M_INO &!INO + INO → I2 + 2NO
                 + DINO !INO + PHOTON → I + NO
          call QSSA(159,'INO',DTCH,QLIN,ST,PROD,LOSS,ZC(159,L))
          
          !//..INO2 ---------------------------------------------
          !PROD = &
  
          LOSS = &               
                 k_ino2_ino2 * M_INO2 &!INO2 + INO2 → I2 + 2NO2 
                 + k_INO2 * M_INO2 &!INO2 → I + NO2
                 + DINO2 !INO2 + PHOTON → I + NO2
          call QSSA(160,'INO2',DTCH,QLIN,ST,PROD,LOSS,ZC(160,L))

          !//..INO3 ---------------------------------------------
          !PROD = &
  
          LOSS = &               
                 k_ino3_i * M_I &!INO3 + I → I2 + NO3
                 + k_INO3 * M_INO3 &!INO3 → IO + NO2
                 + DINO3 !INO3 + PHOTON → I + NO3
          call QSSA(161,'INO3',DTCH,QLIN,ST,PROD,LOSS,ZC(161,L))

          !//..CH3I ---------------------------------------------
          !PROD = &
  
          LOSS = &               
                 k_ch3i_oh * M_OH &!CH3I + OH → H2O + I
                 + DCH3I !CH3I + PHOTON → I
          call QSSA(162,'CH3I',DTCH,QLIN,ST,PROD,LOSS,ZC(162,L))

          !//..CH2I2 ---------------------------------------------
          !PROD = &
  
          LOSS = &               
                 DCH2I2 !CH2I2 + PHOTON → 2I
          call QSSA(163,'CH2I2',DTCH,QLIN,ST,PROD,LOSS,ZC(163,L))

          !//..I2O2 ---------------------------------------------
          PROD = &
                 2 * k_io_io * M_IO * M_IO !IO + IO → I2O2
          LOSS = &               
                 k_i2o2_a * M_I2O2 &!I2O2 → IO + IO
                 + k_i2o2_b * M_I2O2 !I2O2 → OIO + I
                 + DI2O2 !I2O2+ PHOTON → I + OIO (0.21)
          call QSSA(164,'I2O2',DTCH,QLIN,ST,PROD,LOSS,ZC(164,L))

          !//..I2O3 ---------------------------------------------
          PROD = &
                 k_io_oio * M_IO * M_OIO !IO + OIO → I2O3
  
          LOSS = &               
                 DI2O3 !I2O3 + PHOTON → IO + OIO (0.21)
          call QSSA(165,'I2O3',DTCH,QLIN,ST,PROD,LOSS,ZC(165,L))

          !//..I2O4 ---------------------------------------------
          PROD = &
                 k_oio_oio * M_OIO * M_OIO !OIO + OIO → I2O4
          LOSS = &               
                 k_i2o4 * M_I2O4 !I2O4 → 2OIO
                 + DI2O4 !I2O4 + PHOTON → 2OIO (0.21)
          call QSSA(166,'I2O4',DTCH,QLIN,ST,PROD,LOSS,ZC(166,L))

          !//..I ---------------------------------------------
          PROD = &
                 k_hi_oh * M_HI * M_OH &!HI + OH → I + H2O
                 + k_io_no * M_IO * M_NO &!IO + NO → I + NO2
                 + k_ch3i_oh * M_CH3I * M_OH &!CH3I + OH → H2O + I 
                 + k_IO_IO * M_IO * M_IO &!IO + IO → I + OIO
                 + k_i2o2 * M_I2O2 &!I2O2 → OIO + I
                 + k_ino2 * M_INO2 &!INO2 → I + NO2
                 + k_io_clo_a * M_IO * M_ClO &!IO + ClO → I + OClO 
                 + k_io_clo_b * M_IO * M_ClO &!IO + ClO → I + Cl + O2
                 + k_io_br * M_IO * M_Br &!IO + Br → I + BrO
                 + k_io_bro * M_IO * M_BrO &!IO + BrO → Br + I + O2
                 + DCH2IBR * M_CH2IBR &!CH2IBr	+ PHOTON → I + Br
                 + DIBR * M_IBR &!IBr + PHOTON → I +	Br
                 + 2._r8 * DCH2I2 * M_CH2I2 &!CH2I2 + PHOTON →	2I
                 + DCH3I * M_CH3I &!CH3I + PHOTON →	I	
                 + DHOI * M_HOI &!HOI + PHOTON → I + OH
                 + DINO3 * M_INO3 &!INO3 + PHOTON →	I + NO3
                 + 2_r8 * DI2 * M_I2 &!I2	+ PHOTON → 2I
                 + DINO2  * M_INO2 &!INO2	+ PHOTON → I + NO2
                 + DINO * M_INO &!INO + PHOTON → I + NO
                 + DIO * M_IO &!IO + PHOTON → I (0.91)
                 + DOIO * M_OIO &!OIO + PHOTON	→ I + O2
                 + DICL * M_ICL &!ICl + PHOTON	→ I + Cl
                 + DCH2ICL * M_CH2ICL !CH2ICl + PHOTON →	I + Cl
  
          LOSS = & 
                 k_i_o3 * M_O3 &!I + O3 → IO + O2
                 + k_i_ho2 * M_HO2 &!I + HO2 → HI + O2
                 + k_i_bro * M_BrO !I + BrO → IO + Br
          
          call QSSA(173,'I',DTCH,QLIN,ST,PROD,LOSS,ZC(173,L))

          !//..IO ---------------------------------------------
          PROD = &
                 k_i_o3 * M_I * M_O3 &!I + O3 → IO + O2
                 + k_i2o2 * M_I2O2 &!I2O2 → IO + IO
                 + k_ino3 * M_INO3 &!INO3 → IO + NO2
                 + DI2O3 * M_I2O3 !I2O3 + PHOTON → IO + OIO (0.21)
  
          LOSS = & 
                 k_io_io_a * M_IO &!IO + IO → I + OIO
                 + k_io_io_b * M_IO &!IO + IO → I2O2
                 + k_io_oio * M_OIO &!IO + OIO → I2O3
                 + k_io_clo_a * M_ClO &!IO + ClO → I + OClO
                 + k_io_clo_b * M_ClO &!IO + ClO → I + Cl + O2
                 + k_io_clo_c * M_ClO &!IO + ClO → ICl + O2
                 + k_io_br * M_Br &!IO + Br → I + BrO
                 + k_io_bro_a * M_BrO &!IO + BrO → Br + I + O2
                 + k_io_bro_b * M_BrO !IO + BrO → Br + OIO
                 + DIO !IO + PHOTON → I (0.91)
          call QSSA(174,'IO',DTCH,QLIN,ST,PROD,LOSS,ZC(174,L))
          ...
          PROD = &
                 ...
                 + k_i2o4 * M_I2O4 &!I2O4 → 2OIO
                 + k_io_bro_b * M_IO * M_BrO !IO + BrO → Br + OIO
                 + 2_r8 * DI2O4 * M_I2O4 !I2O4 + hv → 2OIO
                 + DI2O2 * M_I2O2 &!I2O2 + hv → I + OIO (0.21)
                 + DI2O3 * M_I2O3 !I2O3 + hv → IO + OIO (0.21)
                 
          LOSS = & 
                 k_oio_oio * M_OIO &!OIO + OIO → I2O4
                 + k_oio_no * M_NO &!OIO + NO → NO2 + IO
                 + k_io_oio * M_OIO !IO + OIO → I2O3
                 + DOIO !OIO + PHOTON → I + O2
          call QSSA(175,'OIO',DTCH,QLIN,ST,PROD,LOSS,ZC(175,L))
        end if !//..End of Halogen Reactions --------------------------------  
        !//...End of Halogen Reactions --------------------------------
        ...
        if (LHAL) LOSS = LOSS &
                         + k_br_ch3cho * M_BR &!Br + CH3CHO → CH3CO3 + HBr
        ...
        LOSS = &
             ...
             + DACETON_B
        if (LHAL) LOSS = LOSS &
                         + k_br_ch3coch3 * M_BR &!Br + CH3COCH3 → PROPAO2 + HBr
                         + k_cl_ch3coch3 * M_Cl !Cl + CH3COCH3 → PROPAO2 + HCl
        ...
        if (LHAL) LOSS = LOSS + k_cl_c2h4 * M_Cl
        ...
        LOSS = k_oh_c3h8 * M_OH 
        if (LHAL) LOSS = LOSS &
                         + k_br_c3h8 * M_BR &!Br + C3H8 → C3H7O2 + HBr
                         + k_cl_c3h8_a * M_Cl &!Cl + C3H8 → C3H7O2 + HCl
                         + k_cl_c3h8_b * M_Cl !Cl + C3H8 → PROPAO2 + Cl
        ...
        LOSS = &
             ...
             + k_o3_c3h6 * M_O3
        if (LHAL) LOSS = LOSS &
                         + k_br_c3h6 * M_BR &!Br + C3H6 → PROPEO2 + HBr
                         + k_cl_c3h6 * M_Cl !Cl + C3H6 → PROPEO2 + HCl
