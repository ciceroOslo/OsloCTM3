   ...
   contains
     ...
     subroutine OSLO_CHEM ( &
       ...
       real(r8) :: &
            ...
            M_H2, &
            AIRMOLEC, &
            !//Added by SK as part of VOC updates
            M_C2H5OH, M_BIGALK, M_BIGENE, M_HOCH2OO, M_ALKO2, M_ALKOOH, M_ALKNIT, &
            M_ENEO2, M_HONITR, M_HCOOH, M_CH3COOH, M_C2H2, M_CH3CO3, &
       ...
       real(r8) :: &
            ...
            k_c2h2_oh !// Added by SK during VOC updates
       ...
       do L = 1, LMTROP !// Integrate up to LMTROP
         ...
         k_hoch2oo_no = r_hoch2oo_no(JTEMP)
         k_no_eneo2_a = r_no_eneo2_a(JTEMP)
         k_no_eneo2_b = r_no_eneo2_b(JTEMP)
         k_no_alko2_b = r_no_alko2_b(JTEMP)
         k_oh_c2h5oh = r_oh_c2h5oh(JTEMP)
         k_oh_alkooh = r_oh_alkooh(JTEMP)
         ...
         k_c2h2_oh = r_c2h2_oh(L) !// Added by SK during VOC updates
         ...
         k_oh_bigalk = r_oh_bigalk
         k_oh_bigene = r_oh_bigene
         k_hcooh_oh = r_hcooh_oh
         k_oh_alknit = r_oh_alknit
         k_oh_honitr = r_oh_honitr
         k_c2h5o2_c2h5o2 = r_c2h5o2_c2h5o2
         k_ch3o2_c2h5o2_b = r_ch3o2_c2h5o2_b
         k_ch3cooh_oh = r_ch3cooh_oh 
         ...
         !//Added by SK during VOC updates
         DHONITR = DACH2O   !//HONITR + hv -> NO2 + 0.67*HO2 + 0.33*CH3CHO + 0.33*CH2O + 0.33*CO + 0.33*GLYALD + 0.33*CH3CO3 + 0.17*HYAC + 0.17*CH3COCH3 jch2o_a
         DALKNIT = DCH3O2H  !//ALKNIT + hv -> NO2 + 0.4*CH3CHO + 0.1*CH2O + 0.25*CH3COCH3 + HO2 + 0.8*MEK jch3ooh
         DALKOOH = DCH3O2H  !//ALKOOH + hv -> 0.4*CH3CHO + 0.1*CH2O + 0.25*CH3COCH3 + 0.9*HO2 + 0.8*MEK + OH jch3ooh
         ...
         do NST = 1, NCHEM_ITER
           ...
           do IIJ = 1, OH_HO2_ITER
             ...
             LOSS_OH = &
                  ...
                  + k_oh_c2h5oh * M_C2H5OH &!C2H5OH + OH -> HO2 + CH3CHO (Added with SK VOC Updates)
                  + k_oh_bigalk * M_BIGALK &!OH + BIGALK -> ALKO2 (Added with SK VOC Updates)
                  + k_oh_bigene * M_BIGENE &!OH + BIGENE -> ENEO2 (Added with SK VOC Updates)
                  + k_c2h2_oh * M_C2H2 &!C2H2 + OH + M -> 0.65GLYOXAL + 0.65OH + 0.35HCOOH + 0.35HO2 + 0.35*CO + M (Added with SK VOC Updates)
             ...
             PROD_HO2 = &
                  ...
                  + 1.2_r8 * k_c2h5o2_c2h5o2 * M_C2H5O2 * M_C2H5O2 &!C2H5O2 + C2H5O2 -> 1.6CH3CHO + 1.2HO2 + 0.4*C2H5OH (added with SK VOC updates)
                  + k_ch3o2_c2h5o2 * M_CH3O2 * M_C2H5O2 &!CH3O2 + C2H5O2 -> 0.7CH2O + 0.8CH3CHO + HO2 + 0.3CH3OH + 0.2C2H5OH (added with SK VOC updates)
                  + k_oh_c2h5oh * M_C2H5OH * M_OH &!C2H5OH + OH -> HO2 + CH3CHO (added with SK VOC updates)
                  + 0.35_r8 * k_c2h2_oh * M_C2H2 * M_OH &!C2H2 + OH + M -> 0.65GLYOXAL + 0.65OH + 0.35HCOOH + 0.35HO2 + 0.35*CO + M (added with SK VOC updates)
                  + k_hoch2oo_no * M_HOCH2OO * M_NO &!HOCH2OO + NO -> HCOOH + NO2 + HO2 (added with SK VOC updates)
                  + 0.13_r8 * k_o3_c2h4 * M_O3 * M_C2H4 &!C2H4 + O3 -> 0.63CO + 0.13OH + 0.13HO2 + 0.37HCOOH + CH2O (added with SK VOC updates)
                  + 0.28_r8 * k_c3h6_o3 * M_O3 * M_C3H6 &!C3H6 + O3 -> 0.5CH2O + 0.12HCOOH + 0.12CH3COOH + 0.5CH3CHO + 0.56CO + 0.28CH3O2 + 0.1CH4 + 0.2CO2 + 0.28HO2 + 0.36OH (added with SK VOC updates)
             ...
             LOSS_HO2 = &
                  ...
                  + k_hoch2oo_ho2 * M_HOCH2OO &!HOCH2OO + HO2 -> HCOOH (added with SK VOC updates)
                  + k_ch3co3_ho2 * M_CH3CO3 &!CH3CO3 + HO2 -> 0.4CH3COOOH + 0.15CH3COOH + 0.15O3 + 0.45OH + 0.45*CH3O2 (added with SK VOC updates)
                  + k_ho2_alko2 * M_ALKO2 &!ALKO2 + HO2 -> ALKOOH
                  !// Extra terms for stability: Must be added to production below
             ...
             LOSS = &
                  ...
                  + 2.0_r8 * k_c2h5o2_c2h5o2 * M_C2H5O2 !C2H5O2 + C2H5O2 -> 1.6*CH3CHO + 1.2*HO2 + 0.4*C2H5OH
             ...
             LOSS = &
                  ...
                  + k_ch3o2_isor1 * M_ISOR1 &
                  + k_ch3o2_isor2 * M_ISOR2 &
                  + k_ch3co3_ch3o2 * M_CH3CO3 &!CH3CO3 + CH3O2 -> 0.9CH3O2 + CH2O + 0.9HO2 + 0.9CO2 + 0.1CH3COOH (added SK VOC Update)
                  + QAER(L) 
        ...
        if (L .eq. 1) DDDIAG(16) = DDDIAG(16) + VDEP_L(16) * M_CH3O2H * DTCH
           ...
           PROD = &
                ...
                + 0.7_r8 * k_ch3o2_c2h5o2 * M_CH3O2 * M_C2H5O2 &!CH3O2 + C2H5O2 -> 0.7*CH2O + 0.8*CH3CHO + HO2 + 0.3*CH3OH + 0.2*C2H5OH (added SK VOC updates)
                + 0.5_r8 * k_no3_bigene * M_BIGENE * M_NO3 &!BIGENE + NO3 -> NO2 + CH3CHO + 0.5CH2O + 0.5CH3COCH3 (added SK VOC updates)
                + k_o3_c2h4 * M_C2H4 * M_O3 &!C2H4 + O3 -> C2H4 + O3 -> 0.63*CO + 0.13*OH + 0.13*HO2 + 0.37*HCOOH + CH2O (added SK VOC updates)
                + 0.5_r8 * k_c3h6_o3 * M_C3H6 * M_O3 &!C3H6 + O3 -> 0.5*CH2O + 0.12*HCOOH + 0.12*CH3COOH + 0.5*CH3CHO + 0.56*CO + 0.28*CH3O2 + 0.1*CH4 + 0.2*CO2 + 0.28*HO2 + 0.36*OH (added SK VOC updates)
                + k_ch3co3_ch3o2 * M_CH3CO3 * M_CH3O2 &!CH3CO3 + CH3O2 -> 0.9*CH3O2 + CH2O + 0.9*HO2 + O.9*CO2 + 0.1*CH3COOH  (added SK VOC updates)
                + k_no_alko2_a * M_ALKO2 * M_NO &!ALKO2 + NO -> 0.4*CH3CHO + 0.1*CH2O + 0.25*CH3COCH3 + HO2 + 0.8*MEK + NO2 (added SK VOC updates)
           ...
           PROD = POLLX(52) +  k_ch3o2_ch3o2_b * M_CH3O2 * M_CH3O2 &
                  + 0.3_r8 * k_ch3o2_c2h5o2 * M_CH3O2 * M_C2H5O2 !CH3O2 + C2H5O2 -> 0.7*CH2O + 0.8*CH3CHO + HO2 + 0.3*CH3OH + 0.2*C2H5OH (added SK VOC updates)
           ...
           PROD = &
                ...
                + POLLX(14) &
                !SK added the following reactions with VOC Update
                + 1.6_r8 * k_c2h5o2_c2h5o2 * M_C2H5O2 * M_C2H5O2 &!C2H5O2 + C2H5O2 -> 1.6*CH3CHO + 1.2*HO2 + 0.4*C2H5OH
                !+ 0.8_r8 * k_ch3o2_c2h5o2 * M_CH3O2 * M_C2H5O2 &!CH3O2 + C2H5O2 -> 0.7*CH2O + 0.8*CH3CHO + HO2 + 0.3*CH3OH + 0.2*C2H5OH
                + k_oh_c2h5oh * M_OH * M_C2H5O2 &!C2H5OH + OH -> HO2 + CH3CHO
                + k_no3_bigene * M_NO3 * M_BIGENE &!NO3 + BIGENE -> CH3CHO + NO2 + 0.5*CH2O + 0.5*CH3COCH3
                + k_c3h6_o3 * M_C3H6 * M_O3 &!C3H6 + O3 ->  0.5*CH2O + 0.12*HCOOH + 0.12*CH3COOH + 0.5*CH3CHO + 0.56*CO + 0.28*CH3O2 + 0.1*CH4 + 0.2*CO2 + 0.28*HO2 + 0.36*OH
           ...
           PROD = &
                   k_c2h5o2_c2h5o2 * M_C2H5O2 * M_C2H5O2 &!C2H5O2 + C2H5O2 -> 1.6*CH3CHO + 1.2*HO2 + 0.4*C2H5OH
                 + k_ch3o2_c2h5o2_b * M_CH3O2 * M_C2H5O2 &!CH3O2 + C2H5O2 -> 0.7*CH2O + 0.8*CH3CHO + HO2 + 0.3*CH3OH + 0.2*C2H5OH (added SK during VOC update)
                 !ABOVE REACTION FROM WACCM IS SLIGHTLY DIFFERENT FROM OLDER OsloCTM3 reaction
                 + POLLX(76)
           ...
           PROD = POLLX(11) &
                  + POLLX (10) &
                  + 0.05_r8 * k_o3_soaC1 * M_Apine * M_O3 &!Using existing SOAC1 reaction rate
                  + 0.05_r8 * k_o3_soaC1 * M_Bpine * M_O3 &
                  + 0.05_r8 * k_o3_soaC2 * M_Limon * M_O3 &
                  + 0.05_r8 * k_o3_soaC4 * M_Myrcene * M_O3 &
                  !+ 0.05_r8 * k_o3_soaC3 * M_MTERP * M_O3 &
           ...
           PROD = &
                ...
                + 0.52_r8 * k_o3_soaC1 * M_Apine * M_O3 &!APIN + O3 -> 0.33*TERPROD1 + 0.3*TERPROD2 + 0.63*OH + 0.57*HO2 + 0.23*CO + 0.27*CO2 + 0.52*CH3COCH3 + 0.34*CH2O + 0.1*BIGALD + 0.05*HCOOH + 0.05*BIGALK + 0.06*CH3CO3 + 0.06*RO2
                + 0.52_r8 * k_o3_soaC1 * M_Bpine * M_O3 &!BPIN + O3 -> 0.33*TERPROD1 + 0.3*TERPROD2 + 0.63*OH + 0.57*HO2 + 0.23*CO + 0.27*CO2 + 0.52*CH3COCH3 + 0.34*CH2O + 0.1*BIGALD + 0.05*HCOOH + 0.05*BIGALK + 0.06*CH3CO3 + 0.06*RO2
                + 0.52_r8 * k_o3_soaC2 * M_Limon * M_O3 &!LIMON + O3 -> 0.33*TERPROD1 + 0.3*TERPROD2 + 0.63*OH + 0.57*HO2 + 0.23*CO + 0.27*CO2 + 0.52*CH3COCH3 + 0.34*CH2O + 0.1*BIGALD + 0.05*HCOOH + 0.05*BIGALK + 0.06*CH3CO3 + 0.06*RO2
                + 0.52_r8 * k_o3_soaC4 * M_Myrcene * M_O3 &!MYRC + O3 -> 0.33*TERPROD1 + 0.3*TERPROD2 + 0.63*OH + 0.57*HO2 + 0.23*CO + 0.27*CO2 + 0.52*CH3COCH3 + 0.34*CH2O + 0.1*BIGALD + 0.05*HCOOH + 0.05*BIGALK + 0.06*CH3CO3 + 0.06*RO2
                !+ 0.52_r8 * M_MTERP * M_O3 &!MTERP + O3 -> 0.33*TERPROD1 + 0.3*TERPROD2 + 0.63*OH + 0.57*HO2 + 0.23*CO + 0.27*CO2 + 0.52*CH3COCH3 + 0.34*CH2O + 0.1*BIGALD + 0.05*HCOOH + 0.05*BIGALK + 0.06*CH3CO3 + 0.06*RO2
                + 0.52_r8 * k_o3_soaC5 * M_Sestrp * M_O3 &!BCARY + O3 -> 0.33*TERPROD1 + 0.3*TERPROD2 + 0.63*OH + 0.57*HO2 + 0.23*CO + 0.27*CO2 + 0.52*CH3COCH3 + 0.34*CH2O + 0.1*BIGALD + 0.05*HCOOH + 0.05*BIGALK + 0.06*CH3CO3 + 0.06*RO2
                + POLLX(50)
           ...
           PROD = & 
                k_hoch2oo_ho2 * M_HOCH2OO  * M_HO2 &! HOCH2OO + HO2 -> HCOOH
                + k_hoch2oo_no * M_HOCH2OO * M_NO &! HOCH2OO + NO -> HCOOH + NO2 + HO2
                + 0.35_r8 * k_c2h2_oh * M_C2H2 * M_OH &!C2H2 + OH + M -> 0.65*GLYOXAL + 0.65*OH + 0.35*HCOOH + 0.35*HO2 + 0.35*CO + M
                + 0.37_r8 * k_o3_c2h4 * M_C2H4 * M_O3 &!C2H4 + O3 -> 0.63*CO + 0.13*OH + 0.13*HO2 + 0.37*HCOOH + CH2O
                + 0.12_r8 * k_c3h6_o3 * M_C3H6 * M_O3 &!C3H6 + O3 -> 0.5*CH2O + 0.12*HCOOH + 0.12*CH3COOH + 0.5*CH3CHO + 0.56*CO + 0.28*CH3O2 + 0.1*CH4 + 0.2*CO2 + 0.28*HO2 + 0.36*OH
                + 0.11_r8 * k_o3_isoprene * M_ISOPREN * M_O3 &!ISOP + O3 -> 0.3*MACR + 0.2*MVK + 0.11*HCOOH + 0.62*CO + 0.32*OH + 0.37*HO2 + 0.91*CH2O + 0.08*CH3CO3 + 0.13*C3H6 + 0.05*CH3O2 
                + 0.05_r8 * k_o3_soaC1 * M_Apine * M_O3 &!APIN + O3 -> 0.33*TERPROD1 + 0.3*TERPROD2 + 0.63*OH + 0.57*HO2 + 0.23*CO + 0.27*CO2 + 0.52*CH3COCH3 + 0.34*CH2O + 0.1*BIGALD + 0.05*HCOOH + 0.05*BIGALK + 0.06*CH3CO3 + 0.06*RO2 
                + 0.05_r8 * k_o3_soaC2 * M_Bpine * M_O3 &!BPIN + O3 -> 0.33*TERPROD1 + 0.3*TERPROD2 + 0.63*OH + 0.57*HO2 + 0.23*CO + 0.27*CO2 + 0.52*CH3COCH3 + 0.34*CH2O + 0.1*BIGALD + 0.05*HCOOH + 0.05*BIGALK + 0.06*CH3CO3 + 0.06*RO2  
                + 0.05_r8 * k_o3_soaC2 * M_Limon * M_O3 &!LIMON + O3 -> 0.33*TERPROD1 + 0.3*TERPROD2 + 0.63*OH + 0.57*HO2 + 0.23*CO + 0.27*CO2 + 0.52*CH3COCH3 + 0.34*CH2O + 0.1*BIGALD + 0.05*HCOOH + 0.05*BIGALK + 0.06*CH3CO3 + 0.06*RO2 
                + 0.05_r8 * k_o3_soaC4 * M_Myrcene * M_O3 &!MYRC + O3 -> 0.33*TERPROD1 + 0.3*TERPROD2 + 0.63*OH + 0.57*HO2 + 0.23*CO + 0.27*CO2 + 0.52*CH3COCH3 + 0.34*CH2O + 0.1*BIGALD + 0.05*HCOOH + 0.05*BIGALK + 0.06*CH3CO3 + 0.06*RO2
                !+ 0.05_r8 * k_MTERP_O3 * M_MTERP * M_O3 &!MTERP + O3 ->0.33*TERPROD1 + 0.3*TERPROD2 + 0.63*OH + 0.57*HO2 + 0.23*CO + 0.27*CO2 + 0.52*CH3COCH3 + 0.34*CH2O + 0.1*BIGALD + 0.05*HCOOH + 0.05*BIGALK + 0.06*CH3CO3 + 0.06*RO2
                + 0.05_r8 * k_o3_soaC5 * M_Sestrp * M_O3 &!BCARY + O3 ->0.33*TERPROD1 + 0.3*TERPROD2 + 0.63*OH + 0.57*HO2 + 0.23*CO + 0.27*CO2 + 0.52*CH3COCH3 + 0.34*CH2O + 0.1*BIGALD + 0.05*HCOOH + 0.05*BIGALK + 0.06*CH3CO3 + 0.06*RO2
                + POLLX(85)
           ...
           PROD = & 
                   0.1_r8 * k_ch3co3_ch3o2 * M_CH3CO3 * M_CH3O2 & !CH3CO3 + CH3O2 -> 0.9*CH3O2 + CH2O + 0.9*HO2 + O.9*CO2 + 0.1*CH3COOH 
                 + 0.15_r8 * k_ch3co3_ho2 * M_CH3CO3 * M_HO2 & !CH3CO3 + HO2 -> 0.4*CH3COOOH + 0.15*CH3COOH + 0.15*O3 + 0.45*OH + 0.45*CH3O2 
                 + 0.12_r8 * k_c3h6_o3 * M_C3H6 * M_O3  &!C3H6 + O3 -> 0.5*CH2O + 0.12*HCOOH + 0.12*CH3COOH + 0.5*CH3CHO + 0.56*CO + 0.28*CH3O2 + 0.1*CH4 + 0.2*CO2 + 0.28*HO2 + 0.36*OH 
           ...
           PROD = &
                k_no_ar3 * M_AR3 * M_NO &
                + POLLX(35) &
                + 0.65_r8 * k_c2h2_oh * M_C2H2 * M_OH !C2H2 + OH + M -> 0.65*GLYOXAL + 0.65*OH + 0.35*HCOOH + 0.35*HO2 + 0.35*CO + M
           ...
           !//..C2H2------------------------------------------------------------
           !//..SK added ethyne in Feb 2025 similar to WACCM------------------------------------------------------------
           PROD = POLLX(87)
           LOSS = &
                  k_c2h2_oh * M_OH
           ...
           if (.not. LSOA) then
              ...
              LOSS = &
                   k_oh_isoprene * M_OH &
                   + k_o3_isoprene * M_O3 &!ISOP + O3 -> 0.3*MACR + 0.2*MVK + 0.11*HCOOH + 0.62*CO + 0.32*OH + 0.37*HO2 + 0.91*CH2O + 0.08*CH3CO3 + 0.13*C3H6 + 0.05*CH3O2 (SK added VOC)
                   + 1.e-5_r8
              call QSSA(43,'ISOPREN',DTCH,QLIN,ST,PROD,LOSS,ZC(20,L))        
